 ...
 * and {@link ZonedDateTime}s. Support for date-time that do not comply to
 * Standard date formats Adapted from the jackson threetenbp InstantDeserializer
 * to add support for deserializing rfc822 format.
 *
 * @author arnoud
 */
public class ConnectivityCheckCustomInstantDeserializer<T extends Temporal>
		extends ThreeTenDateTimeDeserializerBase<T> {
	private static final long serialVersionUID = 1L;

	// @formatter:off
	private static final DateTimeFormatter CONNECTIVITY_CHECK_OFFSET_DATE_TIME = new DateTimeFormatterBuilder()
	...
	private static final DateTimeFormatter CUSTOM_OFFSET_DATE_TIME = CONNECTIVITY_CHECK_OFFSET_DATE_TIME;
	
	private static final DateTimeFormatter CONNECTIVITY_CHECK_ZONED_DATE_TIME = new DateTimeFormatterBuilder()
            .append(CUSTOM_OFFSET_DATE_TIME)
            .optionalStart()
            .appendLiteral('[')
            .parseCaseSensitive()
            .appendZoneRegionId()
	...
	public static final ConnectivityCheckCustomInstantDeserializer<Instant> INSTANT = new ConnectivityCheckCustomInstantDeserializer<Instant>(
	...
	public static final ConnectivityCheckCustomInstantDeserializer<OffsetDateTime> OFFSET_DATE_TIME = new ConnectivityCheckCustomInstantDeserializer<OffsetDateTime>(
			OffsetDateTime.class, CUSTOM_OFFSET_DATE_TIME, new Function<TemporalAccessor, OffsetDateTime>() {
				@Override
	...
	public static final ConnectivityCheckCustomInstantDeserializer<ZonedDateTime> ZONED_DATE_TIME = new ConnectivityCheckCustomInstantDeserializer<ZonedDateTime>(
			ZonedDateTime.class, CONNECTIVITY_CHECK_ZONED_DATE_TIME, new Function<TemporalAccessor, ZonedDateTime>() {
				@Override
	...
	protected ConnectivityCheckCustomInstantDeserializer(Class<T> supportedType, DateTimeFormatter parser,
	...
	protected ConnectivityCheckCustomInstantDeserializer(ConnectivityCheckCustomInstantDeserializer<T> base,
			DateTimeFormatter f) {
	...
	protected JsonDeserializer<T> withDateFormat(DateTimeFormatter dtf) {
		...
		return new ConnectivityCheckCustomInstantDeserializer<T>(this, dtf);
	}
	...
	public T deserialize(JsonParser parser, DeserializationContext context) throws IOException {
		...
		case JsonTokenId.ID_STRING: {
			...
			T value;
			try {
				TemporalAccessor acc = _formatter.parse(string + "Z");
